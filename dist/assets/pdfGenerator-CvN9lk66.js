...
</html>`}async function I(e){const[s,d]=await Promise.all([E("/K_white.png"),E("/firma-kevin.png")]),i=D(),n=`${i}.pdf`,m=_(e,i,s,d),c=document.createElement("iframe");c.style.cssText="position:fixed;left:-9999px;top:0;width:816px;height:2400px;border:none;",document.body.appendChild(c);const r=c.contentDocument;r.open(),r.write(m),r.close();const l=Array.from(r.querySelectorAll("img"));await Promise.all(l.map(o=>o.complete?Promise.resolve():new Promise(a=>{o.onload=()=>a(),o.onerror=()=>a()}))),await new Promise(o=>setTimeout(o,300));const f=r.documentElement.scrollHeight;c.style.height=`${f}px`,await new Promise(o=>setTimeout(o,100));const h=(await T(async()=>{const{default:o}=await import("./pdf-CdRvxDEH.js").then(a=>a.h);return{default:o}},[])).default,t=await h(r.body,{scale:2,useCORS:!0,allowTaint:!1,logging:!1,backgroundColor:"#ffffff",width:816,height:f,windowWidth:816,windowHeight:f});document.body.removeChild(c);const{jsPDF:p}=await T(async()=>{const{jsPDF:o}=await import("./pdf-CdRvxDEH.js").then(a=>a.j);return{jsPDF:o}},[]),u=new p({orientation:"portrait",unit:"mm",format:"letter"}),v=215.9,k=279.4,w=v/t.width,z=t.height*w;if(z<=k){const o=t.toDataURL("image/jpeg",.93);u.addImage(o,"JPEG",0,0,v,z)}else{const o=Math.floor(k/w);let a=0,S=!0;for(;a<t.height;){const x=Math.min(o,t.height-a),g=document.createElement("canvas");g.width=t.width,g.height=x;const y=g.getContext("2d");y.fillStyle="#ffffff",y.fillRect(0,0,g.width,g.height),y.drawImage(t,0,a,t.width,x,0,0,t.width,x);const O=g.toDataURL("image/jpeg",.93),A=x*w;S||u.addPage(),u.addImage(O,"JPEG",0,0,v,A),a+=o,S=!1}}const $=u.output("blob"),P=URL.createObjectURL($),b=document.createElement("a");return b.href=P,b.download=n,document.body.appendChild(b),b.click(),document.body.removeChild(b),setTimeout(()=>URL.revokeObjectURL(P),6e4),{blob:$,filename:n,quoteNumber:i}}export{I as generateQuotationPDF};
