...
const cards = [
  ...
  },
  {
    ...
    icon: BarChart3Icon,
    tagline: 'finanzia.gt · Plataforma externa',
    description:
      'FinanzIA (finanzia.gt) es una plataforma de inteligencia financiera de terceros que integramos en nuestras operaciones. Nos permite ofrecer análisis financiero avanzado con IA a nuestros clientes — no es un producto de KONTAXES.',
    features: [
      'Plataforma externa — finanzia.gt',
      'Dashboards financieros con IA',
      'Análisis y proyecciones de flujo de caja',
      'Reportes ejecutivos automáticos',
      'Alertas e indicadores inteligentes',
    ],
  },
  {
    id: 'felsimple',
    ...
    icon: FileCheckIcon,
    tagline: 'felsimple.com · Convenio de colaboración',
    description:
      'FELSimple (felsimple.com) es una plataforma certificadora de FEL (Factura Electrónica en Línea) ante la SAT con la que KONTAXES tiene convenio de colaboración. No es un producto nuestro — trabajamos juntos para ofrecer emisión FEL integrada.',
    features: [
      'Plataforma externa — felsimple.com',
      'Certificador FEL ante SAT Guatemala',
      'Emisión de facturas XML & PDF',
      'Anulaciones y notas de crédito/débito',
      'Integración vía convenio con Odoo',
    ],
  },
];
